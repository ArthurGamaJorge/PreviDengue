...
export default function Home() {
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-black via-zinc-900 to-zinc-800 text-white px-8 py-12 scroll-smooth">
      ...
      <main className="pt-28">
        <section className="text-center flex flex-col items-center justify-center gap-6 mb-32">
          ...
          <h2 className="text-5xl sm:text-6xl font-bold leading-tight">
            Detecte <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-blue-400 to-white">focos de dengue</span> com a IA
          </h2>
          ...
          <button className="relative inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-blue-500 to-white group-hover:from-pink-500 group-hover:to-orange-400 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800">
        ...
        <section id="sobre" className="max-w-4xl mx-auto text-center mb-32">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="rounded-2xl overflow-hidden">
              <img src="/img1.jpg" alt="Ilustração 1" className="w-full h-auto object-cover" />
            </div>
            <div className="rounded-2xl overflow-hidden">
              <img src="/img2.jpg" alt="Ilustração 2" className="w-full h-auto object-cover" />
            </div>
          </div>
        </section>
